...
//! header. The submission is here too, in `submission`, on `json` alone. The
//! truth file, the case declaration and the case index are #36, #37 and #39 and
...
//!
//! The documents beside the code are `docs/format/trace.md`,
//! `docs/format/submission.md` and `docs/format/dipole.md`, and what they hold
//! that these modules cannot is the reasoning a reader outside this workspace
...
pub use npy::Array;
pub use submission::{Retrieved, Rule, Stopping, Submission};
